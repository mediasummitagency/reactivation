...
type Tab = "business" | "team" | "templates" | "advanced";
...
export function SettingsPage({ settings, profileId, onSaved }: SettingsPageProps) {
          ...
          {activeTab === "team" && (
            <div className="flex flex-col gap-2">
              <div>
                ...
                <p className="mt-0.5 text-xs text-muted-foreground">
                  Add your staff names so clients get personalized messages.
                </p>
              </div>
              <div className="flex min-h-[28px] flex-wrap gap-1.5">
                {techList.length === 0 ? (
                  <span className="text-xs italic text-muted-foreground">No team members added yet.</span>
                ) : (
                  techList.map((tech) => (
                    <span
                      key={tech}
              ...
              <div className="flex gap-2">
                ...
                />
                <Button type="button" variant="outline" size="sm" className="h-8 shrink-0" onClick={addTech}>
                  Add
                </Button>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-start gap-3 rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 dark:border-amber-900/50 dark:bg-amber-950/30">
                ...
                <p className="text-sm text-amber-800 dark:text-amber-300">
                  Demo mode fires drip messages in minutes. Turn this off before going live with a real client.
                </p>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div className="flex flex-col gap-0.5">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Fire drip messages in minutes instead of days.
                  </p>
                </div>
              </div>
            </div>
